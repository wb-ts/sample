    ...
    $(this).each(function () {
      ...
      playButton.click(function () {
        playButton.fadeOut(function () {
          $(this).remove();
          var video_player = '<iframe width="100%" height="100%" src="https://www.youtube.com/embed/' + settings.video_id + '?autoplay=' + "true" + '" frameborder="0" allowfullscreen autoplay></iframe>';
          ...
          if (settings.video_src == 'kaltura' && window.kalturaLoaded) {
            ...
            var video_player = '<iframe src="https://player.vimeo.com/video/' + settings.video_id + '?autoplay=' + "true" + '" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
            video_cont.append(video_player);
          }
        });
